...
const addCategoryList = async (req, res) => {
    try {
        ...
        return res.status(201).json({ mesage: "New CategoryList Information Added", data: createCategoryList });
    } catch (error) {
        console.error(error);
...
const delCategoryList = async (req, res) => {
    try {
        ...
        return res.status(200).json({ mesage: "Delete CategoryList Information", data: deletedInformation });
    } catch (error) {
        console.error(error);
        return res.status(500).json({ mesage: "Internal Server Error", errorMessage: error });
    }
...
const editCategoryList = async (req, res) => {
    try {
        ...
        return res.status(200).json({ mesage: "Update CategoryList Information", data: editInformation });
    } catch (error) {
        console.error(error);
        return res.status(500).json({ mesage: "Internal Server Error", errorMessage: error });
    }
